...
export const OBJECT_ATTRIBUTES_MAP = new Map([
	...
	[
		...
		[
			...
			"entity_logical_name",
			"filter_account_attribute_name",
			"filter_apply_label",
			"filter_definition",
			"filter_enabled",
			"filter_portal_user_attribute_name",
			"filter_website_attribute_name",
			"language_code",
			"page_size",
			"primary_key_name",
			"search_enabled",
	...
	[
		"forloop",
		["first", "index", "index0", "Last", "length", "rindex", "rindex0"],
	],
