...
export const IS_MULTIFILE_FIRST_RUN_EXPERIENCE =
	"isMultiFileFirstRunExperience";
...
export const BACK_TO_STUDIO_URL_TEMPLATE =
	"https://make{.region}.powerpages.microsoft.com/e/{environmentId}/sites/{webSiteId}/pages";

export const STUDIO_PROD_REGION = "prod";

export const ARTEMIS_RESPONSE_FAILED = "Artemis response failed";

export const WEB_EXTENSION_GET_FROM_GRAPH_CLIENT_FAILED =
	"Web extension get from graph client failed";

export const WEB_EXTENSION_FETCH_WORKER_SCRIPT_FAILED =
	"Web extension fetch worker script failed";

export const WEB_EXTENSION_POPULATE_SHARED_WORKSPACE_SYSTEM_ERROR =
	"Web extension populate shared workspace system error";

export const WEB_EXTENSION_WEB_WORKER_REGISTRATION_FAILED =
	"Web extension web worker registration failed";

export const WEB_EXTENSION_FETCH_GET_OR_CREATE_SHARED_WORK_SPACE_ERROR =
	"Web extension fetch get or create shared workspace error";

export const WEB_EXTENSION_QUICK_PICK_DEFAULT_STRING =
	"No users are currently viewing this page";
...
export const GET_OR_CREATE_SHARED_WORK_SPACE =
	"/api/data/v9.2/GetOrCreateSharedWorkspace";
...
export const MICROSOFT_GRAPH_USERS_BASE_URL =
...
export const WEB_EXTENSION_TEAMS_CHAT_NOT_AVAILABLE =
	"Teams chat is not available for this user";

export const WEB_EXTENSION_SEND_EMAIL_NOT_AVAILABLE =
	"Send email is not available for this user";
