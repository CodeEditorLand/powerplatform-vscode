...
import type { ITelemetry } from "../../client/telemetry/ITelemetry";
...
import type { IActiveFileParams, IOrgInfo } from "./model";
...
export class PowerPagesCopilot implements vscode.WebviewViewProvider {
	...
	public async resolveWebviewView(
		...
		webviewView.title =
			vscode.l10n.t("Copilot In Power Pages") +
			(IS_DESKTOP ? "" : " [PREVIEW]");
	...
	private async checkAuthentication() {
		...
		if (session) {
			...
			userID =
				session?.account.id.split("/").pop() ?? session?.account.id;
		} else {
        ...
        <body>
          <div class="copilot-window">
            ...
            <div class="chat-input" id="input-component">
              ...
              <textarea rows=1 placeholder="${vscode.l10n.t(
					"What do you need help with?",
				)}" id="chat-input" class="input-field"></textarea>
