...
import { ECS_REQUEST_URL_TEMPLATE, PowerPagesClientName } from "./constants";
import { ECSFeaturesClient } from "./ecsFeatureClient";
import type { ECSAPIFeatureFlagFilters } from "./ecsFeatureFlagFilters";
import {
	type ECSFeatureDefinition,
	type ECSFeatureInfo,
	createECSFeatureDefinition,
} from "./ecsFeatureProperties";

export function createECSRequestURL(
	filters: ECSAPIFeatureFlagFilters,
	clientName = PowerPagesClientName,
): string {
