...
export const { feature: EnableMultifileVscodeWeb } = getFeatureConfigs({
...
export const { feature: CopilotDisableList } = getFeatureConfigs({
	teamName: PowerPagesClientName,
...
export const { feature: EnableProDevCopilot } = getFeatureConfigs({
	teamName: PowerPagesClientName,
...
export const { feature: EnablePowerPagesGitHubCopilot } = getFeatureConfigs({
	teamName: PowerPagesClientName,
