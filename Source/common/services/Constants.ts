...
export const INTELLIGENCE_SCOPE_DEFAULT =
	"https://text.pai.dynamics.com/.default";
...
export const BAP_SERVICE_SCOPE_DEFAULT =
	"https://api.bap.microsoft.com/.default"; //"https://management.core.windows.net/.default";
