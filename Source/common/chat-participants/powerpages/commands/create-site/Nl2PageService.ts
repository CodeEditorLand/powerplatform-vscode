...
import {
	...
	HOME_PAGE_TYPE,
	INFO_PAGE_TYPE,
	NL2PAGE_GENERATE_NEW_PAGE,
	NL2PAGE_REQUEST_FAILED,
	NL2PAGE_SCENARIO,
	NL2PAGE_SCOPE,
} from "../../PowerPagesChatParticipantConstants";
import {
	VSCODE_EXTENSION_NL2PAGE_REQUEST_FAILED,
	VSCODE_EXTENSION_NL2PAGE_REQUEST_SUCCESS,
...
export async function getNL2PageData(
	...
	telemetry.sendTelemetryEvent(VSCODE_EXTENSION_NL2PAGE_REQUEST_SUCCESS, {
		sessionId,
	});
...
export const generateRandomExampleNumber = (pageType: string) => {
	const isFaqOrAboutPage =
		pageType === FAQ_PAGE_TYPE || pageType === ABOUT_PAGE_TYPE;
