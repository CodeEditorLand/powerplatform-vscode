...
import type { IIntelligenceAPIEndpointInformation } from "../../services/Interfaces";
import {
	ORG_DETAILS_KEY,
...
export class PowerPagesChatParticipant {
	...
	private handler: vscode.ChatRequestHandler = async (
		...
		const intelligenceApiAuthResponse = await intelligenceAPIAuthentication(
			this.telemetry,
	...
	private async handleOrgChangeSuccess(
		...
		const { orgID, orgUrl, environmentID } = handleOrgChangeSuccess(
			orgDetails,
			this.extensionContext,
		);
		this.orgID = orgID;
