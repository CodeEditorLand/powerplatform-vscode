...
export const VSCODE_EXTENSION_PREVIEW_SITE_PAGES =
	"VSCodeExtensionPreviewSitePages";
export const VSCODE_EXTENSION_PREVIEW_SITE_PAGES_ERROR =
	"VSCodeExtensionPreviewSitePagesError";
