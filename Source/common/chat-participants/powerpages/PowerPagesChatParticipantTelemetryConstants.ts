...
export const VSCODE_EXTENSION_NL2PAGE_REQUEST_FAILED =
	"VSCodeExtensionNL2PageRequestFailed";

export const VSCODE_EXTENSION_NL2PAGE_REQUEST_SUCCESS =
	"VSCodeExtensionNL2PageRequestSuccess";

export const VSCODE_EXTENSION_NL2SITE_REQUEST_FAILED =
	"VSCodeExtensionNL2SiteRequestFailed";

export const VSCODE_EXTENSION_NL2SITE_REQUEST_SUCCESS =
	"VSCodeExtensionNL2SiteRequestSuccess";

export const VSCODE_EXTENSION_CREATE_SITE_REQUEST_SUCCESS =
	"VSCodeExtensionNL2SiteRequestSuccess";

export const VSCODE_EXTENSION_CREATE_SITE_COMMAND_FAILED =
	"VSCodeExtensionNL2SiteCommandFailed";

export const VSCODE_EXTENSION_GITHUB_POWER_PAGES_AGENT_COMMAND_TRIGGERED =
	"VSCodeExtensionGitHubPowerPagesAgentCommandTriggered";
